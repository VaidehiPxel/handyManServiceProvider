...
import 'package:flutter_projects/presentation/myJobs/constants/image_constant.dart';
...
class _RenderBodyViewState extends State<RenderBodyView> {
  ...
  Widget _setProviderTitle() {
    return Row(
      ...
      children: [
        Text(
          MyJobsString.listOfServiceProvider,
          style: TextStyle(
            color: Colors.black,
            fontSize: 12.sp,
            fontFamily: AppFonts.poppinsSemiBold,
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Row(
                children: [
                  SvgPicture.asset(MyJobAsset.delete),
                  SizedBox(
                    width: 2.w,
                  ),
                  Text(
      ...
      children: [
                  ...
                  showDialog(
                      ...
                      builder: (BuildContext context) {
                        return DialogBoxWithIcon(
                          ...
                          title: MyJobsString.cong,
                          titleNo: MyJobsString.cancel,
                          titleYes: MyJobsString.startWork,
                          colorNo: AppTheme.black,
                          colorYes: AppTheme.white,
                          sizeNo: 10.sp,
                          titleFamily: AppFonts.poppinsMed,
        ...
        Align(
          ...
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              SvgPicture.asset(MyJobAsset.chat),
              SizedBox(
                width: 2.w,
              ),
              Text(
