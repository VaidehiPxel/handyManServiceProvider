...
class MessageListModel {
  ...
  factory MessageListModel.fromJson(Map<String, dynamic> json) =>
      MessageListModel(
        ...
        getuserchatdetails: List<Getuserchatdetail>.from(
            json["getuserchatdetails"]
                .map((x) => Getuserchatdetail.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "message": message,
        "getuserchatdetails":
            List<dynamic>.from(getuserchatdetails.map((x) => x.toJson())),
      };
}
...
class Getuserchatdetail {
  ...
  factory Getuserchatdetail.fromRawJson(String str) =>
      Getuserchatdetail.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory Getuserchatdetail.fromJson(Map<String, dynamic> json) =>
      Getuserchatdetail(
        id: json["id"],
        userId: json["user_id"],
