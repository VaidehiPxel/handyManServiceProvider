...
class JobReviewRatingModel {
    ...
    factory JobReviewRatingModel.fromRawJson(String str) => JobReviewRatingModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory JobReviewRatingModel.fromJson(Map<String, dynamic> json) => JobReviewRatingModel(
        status: json["status"],
        message: json["message"],
        totalavaragerateing: json["totalavaragerateing"],
        orderaccepted: json["orderaccepted"],
        ordercancel: json["ordercancel"],
        result: List<jobReviewRatingList>.from(json["result"].map((x) => jobReviewRatingList.fromJson(x))),
    );
...
class jobReviewRatingList {
    ...
    factory jobReviewRatingList.fromRawJson(String str) => jobReviewRatingList.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory jobReviewRatingList.fromJson(Map<String, dynamic> json) => jobReviewRatingList(
        id: json["id"],
